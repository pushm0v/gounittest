...
IMAGE_NAME := "pushm0v/gounittest"

default: test

help:
	@echo 'Management commands for gounittest:'
	@echo
	@echo 'Usage:'
...
build-alpine:
	@echo "building ${BIN_NAME} ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -ldflags '-w -linkmode external -extldflags "-static" -X github.com/pushm0v/gounittest/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/pushm0v/gounittest/version.BuildDate=${BUILD_DATE}' -o bin/${BIN_NAME}
